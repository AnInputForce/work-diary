...
| 6    | docker start/stop/rm           |      | #启动/停止/删除容器                  |
...
| 13   | docker info                    |      | 查看docker 信息：比如配置的 Registry地址 |
...
```shell
root@iZ2ze07g4y1jk54sixuao4Z:/etc/docker# docker info
Containers: 0
 Running: 0
 Paused: 0
 Stopped: 0
...
Name: iZ2ze07g4y1jk54sixuao4Z
ID: DIEX:2W3C:ULVK:KJMV:U6T2:NHWX:O364:LZ4E:NS65:QDVY:WGS2:4ZLC
...
Insecure Registries:
 127.0.0.0/8
Registry Mirrors:
 https://s4xbsebr.mirror.aliyuncs.com/
